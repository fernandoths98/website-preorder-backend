...
export class Merchant {
 ...
 @Column({name:'activation_token_hash',type:'char',length:64,nullable:true,select:false}) activationTokenHash:string|null;
 @Column({name:'activation_expires_at',type:'datetime',nullable:true,select:false}) activationExpiresAt:Date|null;
